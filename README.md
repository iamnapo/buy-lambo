...
- Configure the required environment variables as shown in `.env.sample`.
...
```python
from buy_lambo import create_HODL_address, buy_lambo
...
2. Send BTCs to that address through the years...
...
5. If things went as planned, [buy a Lamborghini](https://www.lamborghini.com/en-en/ownership/dealer-locator).
